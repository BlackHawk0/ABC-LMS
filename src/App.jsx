...
function App() {
  ...
  useEffect(() => {
    fetch("https://lms-4etp.onrender.com/admin_auth").then((r) => {
      if (r.ok) {
  ...
  useEffect(() => {
    fetch("https://lms-4etp.onrender.com/teacher_auth").then((r) => {
      if (r.ok) {
        r.json().then((user) => setUser(user));
      }
    });
  ...
  useEffect(() => {
    fetch("https://lms-4etp.onrender.com/student_auth").then((r) => {
      if (r.ok) {
        r.json().then((user) => setUser(user));
      }
    });
  ...
  useEffect(() => {
    fetch("https://lms-4etp.onrender.com/parent_auth").then((r) => {
      if (r.ok) {
        r.json().then((user) => setUser(user));
      }
    });
