...
function LoginForm({ setUser }) {
  ...
  function handleAdminSubmit(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/admin_login", {
      method: "POST",
      headers: {
  ...
  function handleTeacherSubmit(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/teacher_login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function handleStudentSubmit(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/student_login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  function handleParentSubmit(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/parent_login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
