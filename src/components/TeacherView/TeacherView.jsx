...
function TeacherView() {
  ...
  useEffect(() => {
    fetch("https://lms-4etp.onrender.com/teacher_subjects")
      .then((res) => res.json())
      .then((data) => {
        setSubjects(data);
        console.log(data);
  ...
  function handleSubjectSubmit(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/new_subject_teacher", {
      method: "POST",
      headers: {
  ...
  function handleSubjectRemove(id) {
    fetch(`https://lms-4etp.onrender.com/subject_teachers/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
