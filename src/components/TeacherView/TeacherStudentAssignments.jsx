...
function TeacherStudentAssignments() {
  ...
  useEffect(() => {
    fetch(`https://lms-4etp.onrender.com/par_stu_assignments/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setAssignments(data);
      });
  ...
  useEffect(() => {
    fetch(`https://lms-4etp.onrender.com/students/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setStudent(data.full_name);
        setSubject(data.subject);
        fetch(
          `https://lms-4etp.onrender.com/subject_assignments/${data.subject_id}`
        )
          .then((res) => res.json())
          .then((data) => {
  ...
  function handleAddStudentAnAssignment(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/student_assignments", {
      method: "POST",
      headers: {
  ...
  function handleAssignmentDelete(id) {
    fetch(`https://lms-4etp.onrender.com/student_assignments/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
