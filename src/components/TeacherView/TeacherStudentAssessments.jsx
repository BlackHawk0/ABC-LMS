...
function TeacherStudentAssessments() {
  ...
  useEffect(() => {
    fetch(`https://lms-4etp.onrender.com/par_stu_assesments/${id}`)
      .then((res) => res.json())
      .then((data) => {
        setAssesments(data);
      });
  ...
  useEffect(() => {
    fetch(`https://lms-4etp.onrender.com/students/${id}`)
      ...
      .then((data) => {
        ...
        fetch(
          `https://lms-4etp.onrender.com/subject_assessments/${data.subject_id}`
        )
          .then((res) => res.json())
          .then((data) => {
  ...
  function handleAddStudentAnAssesment(e) {
    e.preventDefault();
    fetch("https://lms-4etp.onrender.com/student_assesments", {
      method: "POST",
      headers: {
  ...
  function handleAssesmentDelete(id) {
    fetch(`https://lms-4etp.onrender.com/student_assesments/${id}`, {
      method: "DELETE",
    })
      .then((res) => res.json())
      .then((data) => {
